...
$usuarios = array(
    ...
    array("usuario" => "usuario1", "psw" => "usuario1", "nombre" => "usuario 1", "perfil" => "usuario")
);

$invalido = false; // Variable para controlar si el usuario es válido
...
<body>
    ...
    if ($_SESSION['perfil'] == 'usuario') {
        echo "<a href=\"index.php\">Inicio</a> | ";
        echo "<a href=\"usuario.php\">Gestión de multas</a> | ";
        echo "<a href=\"salir.php\">Cerrar sesión de " . $_SESSION['perfil'] . "</a><br>";
    }
