...
<body>
    ...
    <footer>
        <!--div class="redes">
            <a href="https://www.facebook.com/javier.fernandez.96" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
            <a href="https://twitter.com/javierfernandez96" target="_blank"><i class="fa fa-twitter-square" aria-hidden="true"></i></a>
            <a href="https://www.instagram.com/javierfernandez96/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        </div-->
    </footer>
</body>
